...
@Component({
  selector: 'engineer-location-graph',
  templateUrl: './engineer-location-graph.component.html',
  styleUrls: ['./engineer-location-graph.component.scss']
})
export class EngineerLocationGraphComponent implements OnInit {
  config = CHARTCONFIG;
  ...
  bar4 = {
    ...
    legend: {
      data: ['Total', 'Inprogress', 'User not Available', 'On Hold', 'Resolved'],
      textStyle: {
        color: this.config.textColor
      }
    },
