...
@Component({
  selector: 'volume-filter-form',
  templateUrl: './volume-filter-form.component.html',
  providers: [BusinessAccessDetailsService, ErrorHandlerService, LocationZoneListService],
})
export class VolumeFilterFormComponent implements OnInit {
  ...
  ngOnChanges() {
	...
	onZoneEnvChange(buProject) {
		...
		buProject.updateFormData(this.container.formData)
	}
